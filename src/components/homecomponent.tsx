...
const HomeComponent = () => {
    return (
        <section id="Home" className="flex flex-col relative h-screen w-full bg-zinc-100 z-20 pt-24">
            <div className="mx-auto mt-0 px-16" style={{ maxWidth: "107rem" }}>
                <div className="flex flex-col relative justify-center">
                    <div className="grid grid-cols-2 gap-10">
                        <div className="flex justify-center items-center relative flex-col gap-y-7 pl-6">
                            ...
                            <div className="flex gap-x-4 absolute left-6 bottom-10">
                    ...
                    <div className="flex gap-x-10 pl-8 mt-20">
